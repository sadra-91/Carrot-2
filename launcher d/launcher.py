...
chapw.move(30,70)
chapw.show()
chapl2=QLabel("In our chat application,u can chat with diffrent AI models including Gemma3:1b,Gemma3:4b,llama3.1:8b,Gemma3:12b and Qwen3:14b.\n \nu will have access to diffrent chat features like choosing character for the bot and setting your own character.\n \nThere is even a part for role-playing with AI characters in the app\n \nCarrot is waiting to talk to u!",chapw)
...
assw.move(440,70)
assw.show()
assl2=QLabel("Carrot assistant app,lets u to use AI anywhere without even leaving the page.u can use it to summarize a long message,rewrite your text,understand a complicated scientific text,and etc.\n \nfor using all this features,u only need to select the text and press ctrl + c + m\n \nBut before that,please activate the assistant ↓",assw)
