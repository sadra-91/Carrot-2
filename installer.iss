...
[Files]
Source: "app\PF-Carrot\*"; DestDir: "{app}\app"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "assistant d\C-Assistant\*"; DestDir: "{app}\assistant d"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "launcher d\Carrot-Launcher\*"; DestDir: "{app}\launcher d"; Flags: ignoreversion recursesubdirs createallsubdirs
